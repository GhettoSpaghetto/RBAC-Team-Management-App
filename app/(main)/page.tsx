...
const Home = async () => {
  ...
  return (
    <div className='max-w-4xl mx-auto'>
      ...
      <p className="text-slate-300 mb-8">This demo showcases Next.js 16 access control features with role-based permissions.</p>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-9">
        ...
        <div className="bg-slate-800 p-6 border border-slate-700 rounded-l-lg">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-slate-300">
            ...
            <li><strong className='text-green-400'>Admin: </strong> User and team management</li>
            <li><strong className='text-yellow-400'>Manager: </strong> Team specific management and information</li>
      ...
      {user ? 
        <div className='bg-green-900/30 border border-green-600 rounded-lg p-4'>
          <p className="text-green-300">
            Welcome Back, <strong>Samarth</strong>! You are logged in as {" "}
